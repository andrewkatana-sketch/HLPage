...
nmap -sV --script=http-title -p 80,443,8080,8443,9090,10000,3000,3001,30004,30094,30121,32400,8096,8181,7878,8989,9696,5055,9000,9443 -oG - $live_hosts 2>/dev/null | grep "Ports:" | while read line; do
